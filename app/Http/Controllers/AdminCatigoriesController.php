<?php namespace App\Http\Controllers;
	...
	class AdminCatigoriesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Name Ru","name"=>"name_ru"];
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Name Uz","name"=>"name_uz","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Name Ru","name"=>"name_ru","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
